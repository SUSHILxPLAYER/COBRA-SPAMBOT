...
async def start_curse():
    ...
    if one:
        ...
        try:
            ...
            await bot(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
            await bot(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
    ...
    if two:
        ...
        try:
            ...
            await bot02.start()
            await bot02(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot02(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if three:
        ...
        try:
            ...
            await bot03.start()
            await bot03(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot03(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if four:
        ...
        try:
            ...
            await bot04.start()
            await bot04(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot04(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if five:
        ...
        try:
            ...
            await bot05.start()
            await bot05(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot05(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if six:
        ...
        try:
            ...
            await bot06.start()
            await bot06(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot06(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if seven:
        ...
        try:
            ...
            await bot07.start()
            await bot07(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot07(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if eight:
        ...
        try:
            ...
            await bot08.start()
            await bot08(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot08(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if nine:
        ...
        try:
            ...
            await bot09.start()
            await bot09(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot09(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if ten:
        ...
        try:
            ...
            await bot10.start()
            await bot10(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot10(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if eleven:
        ...
        try:
            ...
            await bot11.start()
            await bot11(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot11(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twelve:
        ...
        try:
            ...
            await bot12.start()
            await bot12(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot12(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirteen:
        ...
        try:
            ...
            await bot13.start()
            await bot13(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot13(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourteen:
        ...
        try:
            ...
            await bot14.start()
            await bot14(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot14(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fifteen:
        ...
        try:
            ...
            await bot15.start()
            await bot15(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot15(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if sixteen:
        ...
        try:
            ...
            await bot16.start()
            await bot16(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot16(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if seventeen:
        ...
        try:
            ...
            await bot17.start()
            await bot17(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot17(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if eighteen:
        ...
        try:
            ...
            await bot18.start()
            await bot18(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot18(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if nineteen:
        ...
        try:
            ...
            await bot19.start()
            await bot19(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot19(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twenty:
        ...
        try:
            ...
            await bot20.start()
            await bot20(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot20(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentyone:
        ...
        try:
            ...
            await bot21.start()
            await bot21(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot21(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentytwo:
        ...
        try:
            ...
            await bot22.start()
            await bot22(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot22(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentythree:
        ...
        try:
            ...
            await bot23.start()
            await bot23(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot23(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentyfour:
        ...
        try:
            ...
            await bot24.start()
            await bot24(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot24(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentyfive:
        ...
        try:
            ...
            await bot25.start()
            await bot25(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot25(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentysix:
        ...
        try:
            ...
            await bot26.start()
            await bot26(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot26(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentyseven:
        ...
        try:
            ...
            await bot27.start()
            await bot27(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot27(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentyeight:
        ...
        try:
            ...
            await bot28.start()
            await bot28(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot28(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if twentynine:
        ...
        try:
            ...
            await bot29.start()
            await bot29(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot29(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirty:
        ...
        try:
            ...
            await bot30.start()
            await bot30(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot30(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtyone:
        ...
        try:
            ...
            await bot31.start()
            await bot31(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot31(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtytwo:
        ...
        try:
            ...
            await bot32.start()
            await bot32(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot32(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtythree:
        ...
        try:
            ...
            await bot33.start()
            await bot33(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot33(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtyfour:
        ...
        try:
            ...
            await bot34.start()
            await bot34(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot34(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtyfive:
        ...
        try:
            ...
            await bot35.start()
            await bot35(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot35(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtysix:
        ...
        try:
            ...
            await bot36.start()
            await bot36(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot36(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtyseven:
        ...
        try:
            ...
            await bot37.start()
            await bot37(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot37(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtyeight:
        ...
        try:
            ...
            await bot38.start()
            await bot38(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot38(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if thirtynine:
        ...
        try:
            ...
            await bot39.start()
            await bot39(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot39(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourty:
        ...
        try:
            ...
            await bot40.start()
            await bot40(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot40(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtyone:
        ...
        try:
            ...
            await bot41.start()
            await bot41(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot41(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtytwo:
        ...
        try:
            ...
            await bot42.start()
            await bot42(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot42(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtythree:
        ...
        try:
            ...
            await bot43.start()
            await bot43(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot43(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtyfour:
        ...
        try:
            ...
            await bot44.start()
            await bot44(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot44(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtyfive:
        ...
        try:
            ...
            await bot45.start()
            await bot45(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot45(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtysix:
        ...
        try:
            ...
            await bot46.start()
            await bot46(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot46(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtyseven:
        ...
        try:
            ...
            await bot47.start()
            await bot47(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot47(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtyeight:
        ...
        try:
            ...
            await bot48.start()
            await bot48(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot48(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fourtynine:
        ...
        try:
            ...
            await bot49.start()
            await bot49(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot49(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
    ...
    if fifty:
        ...
        try:
            ...
            await bot50.start()
            await bot50(functions.channels.JoinChannelRequest(channel="@demonstoreop"))
            await bot50(functions.channels.JoinChannelRequest(channel="@dragneel_abhi"))
