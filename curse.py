...
async def start_curse():
    ...
    if one:
        ...
        try:
            ...
            await bot(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if two:
        ...
        try:
            ...
            await bot02.start()
            await bot02(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot02(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if three:
        ...
        try:
            ...
            await bot03.start()
            await bot03(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot03(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if four:
        ...
        try:
            ...
            await bot04.start()
            await bot04(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot04(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if five:
        ...
        try:
            ...
            await bot05.start()
            await bot05(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot05(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if six:
        ...
        try:
            ...
            await bot06.start()
            await bot06(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot06(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if seven:
        ...
        try:
            ...
            await bot07.start()
            await bot07(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot07(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if eight:
        ...
        try:
            ...
            await bot08.start()
            await bot08(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot08(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if nine:
        ...
        try:
            ...
            await bot09.start()
            await bot09(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot09(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
    ...
    if ten:
        ...
        try:
            ...
            await bot10.start()
            await bot10(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
            await bot10(functions.channels.JoinChannelRequest(channel="@Clan8xofficial"))
